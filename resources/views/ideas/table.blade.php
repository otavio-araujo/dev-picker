<section class="container px-4 mx-auto">
    <div class="sm:flex sm:items-center sm:justify-between">
        ...
        <div class="flex items-center mt-4 gap-x-3">
            <button
                class="flex items-center justify-center w-1/2 px-5 py-2 text-sm text-gray-700 transition-colors duration-200 bg-white border rounded-lg gap-x-2 hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-200 dark:hover:bg-gray-800 sm:w-auto">
                <svg fill="none" height="20" viewBox="0 0 20 20" width="20" xmlns="http://www.w3.org/2000/svg">
                    <g clip-path="url(#clip0_3098_154395)">
                        <path
                            ...
                            stroke-linecap="round" stroke-linejoin="round" stroke-width="1.67" stroke="currentColor" />
                    </g>
                    <defs>
            ...
            <button
                class="flex items-center justify-center w-1/2 px-5 py-2 text-sm tracking-wide text-white transition-colors duration-200 bg-blue-500 rounded-lg shrink-0 gap-x-2 hover:bg-blue-600 dark:bg-blue-600 dark:hover:bg-blue-500 sm:w-auto">
    ...
    <div class="mt-6 md:flex md:items-center md:justify-between">
        <div
            class="inline-flex overflow-hidden bg-white border divide-x rounded-lg rtl:flex-row-reverse dark:divide-gray-700 dark:border-gray-700 dark:bg-gray-900">
            <button
                class="px-5 py-2 text-xs font-medium text-gray-600 transition-colors duration-200 bg-gray-100 dark:bg-gray-800 dark:text-gray-300 sm:text-sm">
                View all
            </button>
        ...
        <div class="relative flex items-center mt-4 md:mt-0">
            <span class="absolute">
                <svg class="w-5 h-5 mx-3 text-gray-400 dark:text-gray-600" fill="none" stroke-width="1.5"
                            ...
                            <tr>
                                <th class="px-4 py-3.5 text-left text-sm font-normal text-gray-500 rtl:text-right dark:text-gray-400"
                                    ...
                                    <button class="flex items-center gap-x-3 focus:outline-none">
                                        ...
                                        <svg class="h-3" fill="none" viewBox="0 0 10 11"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <path
                                            ...
                                            <path
                                                ...
                                                fill="currentColor" stroke-width="0.3" stroke="currentColor" />
                                        </svg>
                                    </button>
                                </th>
                        ...
                        <tbody class="bg-white divide-y divide-gray-200 dark:divide-gray-700 dark:bg-gray-900">
                            <tr>
                                ...
                                <td class="px-12 py-4 text-sm font-medium whitespace-nowrap">
                                    <div
                                        class="inline px-3 py-1 text-sm font-normal rounded-full gap-x-2 bg-emerald-100/60 text-emerald-500 dark:bg-gray-800">
                                        Customer
                                    </div>
                                </td>
                                ...
                                <td class="px-4 py-4 text-sm whitespace-nowrap">
                                    <div class="flex items-center">
                                        <img alt=""
                                            class="object-cover w-6 h-6 -mx-1 border-2 border-white rounded-full shrink-0 dark:border-gray-700"
                                ...
                                <td class="px-4 py-4 text-sm whitespace-nowrap">
                                    <button
                                        class="px-1 py-1 text-gray-500 transition-colors duration-200 rounded-lg hover:bg-gray-100 dark:text-gray-300">
                            ...
                            <tr>
                                ...
                                <td class="px-12 py-4 text-sm font-medium whitespace-nowrap">
                                    <div
                                        class="inline px-3 py-1 text-sm font-normal text-gray-500 bg-gray-100 rounded-full gap-x-2 dark:bg-gray-800 dark:text-gray-400">
                                        Churned
                                    </div>
                                </td>
                                <td class="px-4 py-4 text-sm whitespace-nowrap">
    ...
    <div class="mt-6 sm:flex sm:items-center sm:justify-between">
        ...
        <div class="flex items-center mt-4 gap-x-4 sm:mt-0">
            <a class="flex items-center justify-center w-1/2 px-5 py-2 text-sm text-gray-700 capitalize transition-colors duration-200 bg-white border rounded-md gap-x-2 hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-200 dark:hover:bg-gray-800 sm:w-auto"
                href="#">
