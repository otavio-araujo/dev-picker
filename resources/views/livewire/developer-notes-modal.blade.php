                    ...
                    @if ($this->developerNotes != null)
                                ...
                                <div class="flex flex-col w-full divide-y">
                                    <div class="flex items-center justify-between p-2">
                                        ...
                                        <div class="flex items-center gap-x-1">
                                            ...
                                            {{-- <x-icon-button
                                                class="text-red-600 hover:text-red-700 hover:shadow-sm focus:text-red-700 active:text-red-900"
                                                wire:click="deleteDeveloperNote({{ $note->id }})">
                        ...
                        @empty
                            <li class="py-4 pl-4 pr-5 text-sm leading-6 lg:flex-row lg:items-center lg:gap-y-0">
                                ...
                                <p class="p-2 font-semibold text-center text-gray-700 text-md">Sem observações</p>
                            </li>
                        @endforelse
                    @endif
                ...
                <div class="pt-4 mt-4 border-t border-gray-300 p4">
                    <form wire:submit="createDeveloperNote">
                        <div class="w-full mb-4">
                            <x-label for="note">Cadastrar Observações:</x-label>
